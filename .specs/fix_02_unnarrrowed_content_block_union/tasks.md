...
- [x] 2. Validate existing tests still pass
  - [x] 2.1 Run `uv run pytest tests/unit/spec/test_ai_validator.py -v` — all existing tests must pass without modification
  - [x] 2.V Verify: confirm zero test failures
